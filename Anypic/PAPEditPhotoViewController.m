...
- (BOOL)shouldUploadImage:(UIImage *)anImage {    
    ...
    NSLog(@"Requested background expiration task with id %d for Azadi photo upload", self.fileUploadBackgroundTaskId);
...
- (void)doneButtonAction:(id)sender {
    ...
    double latitude_double = [[NSUserDefaults standardUserDefaults] doubleForKey:@"latitude"] ;
    NSNumber *latitude = [NSNumber numberWithDouble:latitude_double];
    double longitude_double = [[NSUserDefaults standardUserDefaults] doubleForKey:@"longitude"] ;
    NSNumber *longitude = [NSNumber numberWithDouble:longitude_double];
    
    photo[@"latitude"] = latitude;
    photo[@"longitude"] = longitude;

    [photo setValue:latitude forKey:@"latitude"];
   // [photo setObject:[[NSUserDefaults standardUserDefaults]
                //      stringForKey:@"latitute"] forKey:@"latitude"];
   // [photo setObject:[[NSUserDefaults standardUserDefaults]
             //         stringForKey:@"longitude"] forKey:@"longitude"];
